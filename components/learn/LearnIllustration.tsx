    ...
    <svg width={size} height={size} viewBox="0 0 260 260" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        <pattern id="aw-grid" width="20" height="20" patternUnits="userSpaceOnUse">
          <path d="M 20 0 L 0 0 0 20" fill="none" stroke="#C8F13F08" strokeWidth="0.5"/>
        </pattern>
        <filter id="aw-glow">
      ...
      {[
        ...
        <g key={i}>
          <rect x={(260 - w) / 2} y={y} width={w} height={22}
            fill="#0D0D0D" stroke="#C8F13F" strokeOpacity={0.12 + i * 0.06} strokeWidth="0.5" />
          <rect x={(260 - w) / 2} y={y} width={w * 0.3} height={22}
            fill="#C8F13F" fillOpacity={0.04 + i * 0.012} />
          <text x="130" y={y + 14} textAnchor="middle" fill="#C8F13F"
      ...
      {/* Connector lines */}
      <line x1="130" y1="62" x2="130" y2="40" stroke="#C8F13F" strokeOpacity="0.3" strokeWidth="0.5" strokeDasharray="3 3" />
      {/* Top node — Zela */}
      <circle cx="130" cy="34" r="10" fill="#0D0D0D" stroke="#C8F13F" strokeOpacity="0.6" strokeWidth="0.8" />
      <text x="130" y="37" textAnchor="middle" fill="#C8F13F" fontFamily="JetBrains Mono,monospace" fontSize="6.5" fontWeight="bold">ZELA</text>

      {/* Glow at center */}
      <ellipse cx="130" cy="130" rx="50" ry="40" fill="#C8F13F" fillOpacity="0.02" />
    </svg>
  )
}
    ...
    <svg width={size} height={size} viewBox="0 0 260 260" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {blocks.map(({ x, label, hash }, i) => (
        <g key={i}>
          ...
          {i > 0 && (
            <g>
              <line x1={x - 14} y1="130" x2={x + 2} y2="130" stroke="#C8F13F" strokeOpacity="0.35" strokeWidth="0.8" />
              <polygon points={`${x + 2},127 ${x + 2},133 ${x + 8},130`} fill="#C8F13F" fillOpacity="0.35" />
            </g>
          )}
          {/* Block body */}
          <rect x={x} y={95} width={60} height={70} fill="#0D0D0D" stroke="#C8F13F"
            strokeOpacity={i === 2 ? 0.7 : 0.2} strokeWidth={i === 2 ? '0.8' : '0.4'} />
          {i === 2 && <rect x={x} y={95} width={60} height={4} fill="#C8F13F" fillOpacity="0.6" />}
          {/* Block label */}
          <text x={x + 30} y={113} textAnchor="middle" fill="#C8F13F"
            fillOpacity={i === 2 ? 0.9 : 0.5} fontFamily="JetBrains Mono,monospace" fontSize="7" fontWeight="bold">
            BLOCK
          </text>
          <text x={x + 30} y={123} textAnchor="middle" fill="#C8F13F"
      ...
      <line x1="216" y1="130" x2="240" y2="130" stroke="#C8F13F" strokeOpacity="0.2" strokeWidth="0.6" strokeDasharray="4 3" />
    </svg>
  )
}
    ...
    <svg width={size} height={size} viewBox="0 0 260 260" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        ...
        <radialGradient id="coin-grad" cx="50%" cy="50%" r="50%">
          <stop offset="0%" stopColor="#C8F13F" stopOpacity="0.25" />
          <stop offset="100%" stopColor="#C8F13F" stopOpacity="0" />
        </radialGradient>
      </defs>
      <rect width="260" height="260" fill="url(#cr-grid)" />

      {/* Coin */}
      <circle cx="130" cy="105" r="46" fill="#0D0D0D" stroke="#C8F13F" strokeOpacity="0.6" strokeWidth="1" />
      <circle cx="130" cy="105" r="38" fill="#111" stroke="#C8F13F" strokeOpacity="0.2" strokeWidth="0.4" />
      <text x="130" y="100" textAnchor="middle" fill="#C8F13F" fillOpacity="0.9"
        fontFamily="JetBrains Mono,monospace" fontSize="22" fontWeight="bold">₿</text>
      <text x="130" y="116" textAnchor="middle" fill="#C8F13F" fillOpacity="0.5"
      ...
      <text x="61" y="188" textAnchor="middle" fill="#C8F13F" fillOpacity="0.6" fontFamily="JetBrains Mono,monospace" fontSize="6">SENDER</text>
      <text x="61" y="200" textAnchor="middle" fill="#555" fontFamily="JetBrains Mono,monospace" fontSize="5.5">0x4a3b…</text>

      <rect x="166" y="174" width="66" height="36" rx="2" fill="#0D0D0D" stroke="#C8F13F" strokeOpacity="0.25" strokeWidth="0.5" />
      <text x="199" y="188" textAnchor="middle" fill="#C8F13F" fillOpacity="0.6" fontFamily="JetBrains Mono,monospace" fontSize="6">RECEIVER</text>
      <text x="199" y="200" textAnchor="middle" fill="#555" fontFamily="JetBrains Mono,monospace" fontSize="5.5">0x9f1c…</text>

      {/* Arrow between */}
      <line x1="97" y1="192" x2="163" y2="192" stroke="#C8F13F" strokeOpacity="0.4" strokeWidth="0.8" strokeDasharray="4 3" />
      <polygon points="163,189 163,195 170,192" fill="#C8F13F" fillOpacity="0.4" />
      <text x="130" y="187" textAnchor="middle" fill="#C8F13F" fillOpacity="0.5" fontFamily="JetBrains Mono,monospace" fontSize="5.5">0.05 BTC</text>

      {/* Connecting lines from coin to boxes */}
      <line x1="97" y1="147" x2="61" y2="174" stroke="#C8F13F" strokeOpacity="0.12" strokeWidth="0.4" />
      <line x1="163" y1="147" x2="199" y2="174" stroke="#C8F13F" strokeOpacity="0.12" strokeWidth="0.4" />
    </svg>
  )
}
    ...
    <svg width={size} height={size} viewBox="0 0 260 260" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <defs>
        ...
        <radialGradient id="pool-glow" cx="50%" cy="50%" r="50%">
          <stop offset="0%" stopColor="#C8F13F" stopOpacity="0.08" />
          <stop offset="100%" stopColor="#C8F13F" stopOpacity="0" />
        </radialGradient>
      </defs>
      ...
      {/* Pool container */}
      <ellipse cx="130" cy="148" rx="52" ry="18" fill="#0D0D0D" stroke="#C8F13F" strokeOpacity="0.5" strokeWidth="0.8" />
      <rect x="78" y="100" width="104" height="48" fill="#0D0D0D" stroke="#C8F13F" strokeOpacity="0.15" strokeWidth="0.5" />
      <rect x="78" y="100" width="104" height="48" fill="url(#pool-glow)" />
      <ellipse cx="130" cy="100" rx="52" ry="18" fill="#0D0D0D" stroke="#C8F13F" strokeOpacity="0.3" strokeWidth="0.6" />

      {/* Pool labels */}
      <text x="108" y="126" textAnchor="middle" fill="#C8F13F" fillOpacity="0.6" fontFamily="JetBrains Mono,monospace" fontSize="7">ETH</text>
      ...
      <line x1="50" y1="60" x2="90" y2="95" stroke="#C8F13F" strokeOpacity="0.3" strokeWidth="0.7" strokeDasharray="4 3" />
      <rect x="20" y="40" width="55" height="28" rx="2" fill="#0D0D0D" stroke="#1A1A1A" strokeWidth="0.5" />
      <text x="47" y="52" textAnchor="middle" fill="#C8F13F" fillOpacity="0.5" fontFamily="JetBrains Mono,monospace" fontSize="6">LIQUIDITY</text>
      ...
      {/* Fee arrow bottom */}
      <line x1="130" y1="166" x2="130" y2="196" stroke="#C8F13F" strokeOpacity="0.3" strokeWidth="0.7" strokeDasharray="4 3" />
      <rect x="95" y="196" width="70" height="26" rx="2" fill="#0D0D0D" stroke="#C8F13F" strokeOpacity="0.25" strokeWidth="0.5" />
      <text x="130" y="208" textAnchor="middle" fill="#C8F13F" fillOpacity="0.5" fontFamily="JetBrains Mono,monospace" fontSize="6">0.3% FEES</text>
...
function NftIllustration({ size }: { size: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 260 260" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* NFT card */}
      <rect x="70" y="50" width="120" height="140" fill="#0D0D0D" stroke="#C8F13F" strokeOpacity="0.5" strokeWidth="0.8" />
      {/* Accent top bar */}
      <rect x="70" y="50" width="120" height="4" fill="#C8F13F" fillOpacity="0.5" />
      {/* Abstract art area */}
      <rect x="78" y="62" width="104" height="80" fill="#111" stroke="#1A1A1A" strokeWidth="0.4" />
      {/* Art elements */}
      <circle cx="130" cy="102" r="24" fill="none" stroke="#C8F13F" strokeOpacity="0.4" strokeWidth="1.5" />
      <circle cx="118" cy="94" r="10" fill="#C8F13F" fillOpacity="0.08" stroke="#C8F13F" strokeOpacity="0.3" strokeWidth="0.6" />
      <polygon points="130,78 145,102 115,102" fill="none" stroke="#C8F13F" strokeOpacity="0.2" strokeWidth="0.7" />
      <rect x="106" y="98" width="48" height="28" fill="none" stroke="#C8F13F" strokeOpacity="0.12" strokeWidth="0.5" />

      {/* Token ID */}
      <text x="130" y="161" textAnchor="middle" fill="#C8F13F" fillOpacity="0.8" fontFamily="JetBrains Mono,monospace" fontSize="7" fontWeight="bold">TOKEN #0042</text>
      {/* Owner */}
      ...
      {/* Corner accents */}
      <line x1="70" y1="58" x2="80" y2="58" stroke="#C8F13F" strokeOpacity="0.4" strokeWidth="1.5" />
      <line x1="70" y1="58" x2="70" y2="68" stroke="#C8F13F" strokeOpacity="0.4" strokeWidth="1.5" />
      <line x1="190" y1="58" x2="180" y2="58" stroke="#C8F13F" strokeOpacity="0.4" strokeWidth="1.5" />
      <line x1="190" y1="58" x2="190" y2="68" stroke="#C8F13F" strokeOpacity="0.4" strokeWidth="1.5" />
      <line x1="70" y1="182" x2="80" y2="182" stroke="#C8F13F" strokeOpacity="0.2" strokeWidth="1" />
      <line x1="70" y1="182" x2="70" y2="172" stroke="#C8F13F" strokeOpacity="0.2" strokeWidth="1" />
      <line x1="190" y1="182" x2="180" y2="182" stroke="#C8F13F" strokeOpacity="0.2" strokeWidth="1" />
      <line x1="190" y1="182" x2="190" y2="172" stroke="#C8F13F" strokeOpacity="0.2" strokeWidth="1" />
    ...
    <svg width={size} height={size} viewBox="0 0 260 260" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {[0,1,2].map(row => [0,1,2,3].map(col => (
        <rect key={`${row}-${col}`} x={96 + col * 18} y={98 + row * 22} width="12" height="14"
          fill={row === 0 && col === 1 ? '#C8F13F' : '#1A1A1A'}
          fillOpacity={row === 0 && col === 1 ? 0.3 : 1}
          stroke="#C8F13F" strokeOpacity="0.08" strokeWidth="0.3" />
      )))}
      {/* Roof */}
      <polygon points="86,90 130,58 174,90" fill="#0D0D0D" stroke="#1A1A1A" strokeWidth="0.5" />

      {/* Tokenization arrow + tokens */}
      <line x1="174" y1="130" x2="208" y2="130" stroke="#C8F13F" strokeOpacity="0.4" strokeWidth="0.8" strokeDasharray="4 3" />
      ...
      {[0,1,2,3].map(i => (
        <rect key={i} x={212} y={120 - i * 6} width="34" height="20" rx="2"
          fill="#0D0D0D" stroke="#C8F13F" strokeOpacity={0.15 + i * 0.15} strokeWidth="0.5" />
      ))}
      <text x="229" y="127" textAnchor="middle" fill="#C8F13F" fillOpacity="0.7"
      ...
      <text x="49" y="133" textAnchor="middle" fill="#C8F13F" fillOpacity="0.7" fontFamily="JetBrains Mono,monospace" fontSize="9" fontWeight="bold">$2M</text>
...
function WalletCompareIllustration({ size }: { size: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 260 260" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* RIGHT — Non-custodial */}
      <text x="195" y="58" textAnchor="middle" fill="#C8F13F" fillOpacity="0.8" fontFamily="JetBrains Mono,monospace" fontSize="7" letterSpacing="1">NON-CUSTODIAL</text>
      {/* Wallet icon */}
      <rect x="162" y="68" width="76" height="52" rx="3" fill="#0D0D0D" stroke="#C8F13F" strokeOpacity="0.4" strokeWidth="0.7" />
      <rect x="182" y="82" width="36" height="22" rx="10" fill="#111" stroke="#C8F13F" strokeOpacity="0.3" strokeWidth="0.5" />
      <circle cx="200" cy="93" r="6" fill="#C8F13F" fillOpacity="0.08" stroke="#C8F13F" strokeOpacity="0.5" strokeWidth="0.7" />
      {/* Key */}
      <circle cx="195" cy="140" r="10" fill="#0D0D0D" stroke="#C8F13F" strokeOpacity="0.6" strokeWidth="0.8" />
      <line x1="205" y1="140" x2="224" y2="140" stroke="#C8F13F" strokeOpacity="0.6" strokeWidth="1.5" />
      <line x1="218" y1="140" x2="218" y2="148" stroke="#C8F13F" strokeOpacity="0.6" strokeWidth="1.5" />
      <line x1="224" y1="140" x2="224" y2="148" stroke="#C8F13F" strokeOpacity="0.6" strokeWidth="1.5" />
      <text x="195" y="162" textAnchor="middle" fill="#C8F13F" fillOpacity="0.6" fontFamily="JetBrains Mono,monospace" fontSize="5.5">YOU HOLD</text>
      <text x="195" y="172" textAnchor="middle" fill="#C8F13F" fillOpacity="0.6" fontFamily="JetBrains Mono,monospace" fontSize="5.5">YOUR KEYS</text>
...
function KeyIllustration({ size }: { size: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 260 260" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Seed phrase box */}
      <rect x="40" y="40" width="180" height="50" fill="#0D0D0D" stroke="#C8F13F" strokeOpacity="0.5" strokeWidth="0.7" />
      <text x="130" y="57" textAnchor="middle" fill="#C8F13F" fillOpacity="0.5" fontFamily="JetBrains Mono,monospace" fontSize="6" letterSpacing="1">SEED PHRASE (12 WORDS)</text>
      ...
      {/* Derivation arrow */}
      <line x1="130" y1="90" x2="130" y2="108" stroke="#C8F13F" strokeOpacity="0.3" strokeWidth="0.7" />
      <polygon points="126,108 134,108 130,116" fill="#C8F13F" fillOpacity="0.3" />

      {/* Private keys branch */}
      <line x1="90" y1="116" x2="170" y2="116" stroke="#C8F13F" strokeOpacity="0.15" strokeWidth="0.5" />
      <line x1="90" y1="116" x2="90" y2="132" stroke="#C8F13F" strokeOpacity="0.15" strokeWidth="0.5" />
      <line x1="130" y1="116" x2="130" y2="132" stroke="#C8F13F" strokeOpacity="0.15" strokeWidth="0.5" />
      <line x1="170" y1="116" x2="170" y2="132" stroke="#C8F13F" strokeOpacity="0.15" strokeWidth="0.5" />
      ...
      {[
        ...
        <g key={label}>
          <rect x={x} y={132} width="46" height="32" fill="#0D0D0D" stroke="#C8F13F" strokeOpacity="0.2" strokeWidth="0.5" />
          <text x={x + 23} y={144} textAnchor="middle" fill="#C8F13F" fillOpacity="0.5" fontFamily="JetBrains Mono,monospace" fontSize="5.5">{label}</text>
          <text x={x + 23} y={156} textAnchor="middle" fill="#444" fontFamily="JetBrains Mono,monospace" fontSize="5">{addr}</text>
          {/* Arrow to address */}
          <line x1={x + 23} y1={164} x2={x + 23} y2={178} stroke="#C8F13F" strokeOpacity="0.12" strokeWidth="0.5" />
...
function SmartContractIllustration({ size }: { size: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 260 260" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="85" y="55" width="90" height="130" rx="4" fill="#0D0D0D" stroke="#C8F13F" strokeOpacity="0.4" strokeWidth="0.8" />
      {/* Screen */}
      <rect x="95" y="65" width="70" height="40" fill="#111" stroke="#C8F13F" strokeOpacity="0.2" strokeWidth="0.4" />
      <text x="130" y="81" textAnchor="middle" fill="#C8F13F" fillOpacity="0.8" fontFamily="JetBrains Mono,monospace" fontSize="7">IF condition</text>
      <text x="130" y="91" textAnchor="middle" fill="#C8F13F" fillOpacity="0.5" fontFamily="JetBrains Mono,monospace" fontSize="7">THEN execute</text>
      ...
      {[0,1].map(row => [0,1,2].map(col => (
        <rect key={`${row}-${col}`} x={93 + col * 24} y={114 + row * 28} width="20" height="22"
          fill="#111" stroke="#C8F13F" strokeOpacity="0.1" strokeWidth="0.4" />
      )))}

      {/* Coin slot */}
      <rect x="148" y="165" width="20" height="8" rx="2" fill="#111" stroke="#C8F13F" strokeOpacity="0.3" strokeWidth="0.5" />
      <text x="158" y="172" textAnchor="middle" fill="#C8F13F" fillOpacity="0.4" fontFamily="JetBrains Mono,monospace" fontSize="5">▶</text>

      {/* Dispense slot */}
      <rect x="95" y="176" width="70" height="6" rx="1" fill="#0A0A0A" stroke="#333" strokeWidth="0.4" />

      {/* Input arrow left */}
      <line x1="40" y1="130" x2="82" y2="130" stroke="#C8F13F" strokeOpacity="0.4" strokeWidth="0.8" strokeDasharray="4 3" />
      <polygon points="82,127 82,133 88,130" fill="#C8F13F" fillOpacity="0.4" />
      ...
      {/* Output arrow right */}
      <line x1="178" y1="130" x2="216" y2="130" stroke="#C8F13F" strokeOpacity="0.4" strokeWidth="0.8" strokeDasharray="4 3" />
      <polygon points="216,127 216,133 222,130" fill="#C8F13F" fillOpacity="0.4" />
      <text x="224" y="120" textAnchor="middle" fill="#C8F13F" fillOpacity="0.6" fontFamily="JetBrains Mono,monospace" fontSize="6">TOKEN</text>
...
function DaoIllustration({ size }: { size: number }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 260 260" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Center proposal */}
      <circle cx="130" cy="130" r="32" fill="#0D0D0D" stroke="#C8F13F" strokeOpacity="0.5" strokeWidth="0.8" />
      <circle cx="130" cy="130" r="26" fill="#0A0A0A" stroke="#C8F13F" strokeOpacity="0.15" strokeWidth="0.4" />
      <text x="130" y="124" textAnchor="middle" fill="#C8F13F" fillOpacity="0.7" fontFamily="JetBrains Mono,monospace" fontSize="7" fontWeight="bold">PROPOSAL</text>
      ...
      {voters.map(({ x, y, tokens, vote }) => (
        <g key={`${x}-${y}`}>
          ...
          <line x1={x} y1={y} x2={130} y2={130}
            stroke={vote === 'YES' ? '#C8F13F' : '#FF4444'} strokeOpacity="0.18" strokeWidth="0.6" strokeDasharray="4 3" />
          {/* Voter node */}
          <circle cx={x} cy={y} r="18" fill="#0D0D0D"
            stroke={vote === 'YES' ? '#C8F13F' : '#FF4444'}
      ...
      <rect x="40" y="220" width="130" height="10" rx="2" fill="#C8F13F" fillOpacity="0.3" />
      <text x="105" y="229" textAnchor="middle" fill="#C8F13F" fillOpacity="0.7" fontFamily="JetBrains Mono,monospace" fontSize="5.5">72% YES</text>
